...
- [ ] **G0-06 — Local/CI synthetic environment** - Blocked/15%; Docker Desktop 29.7.2 daemon and `hello-world` verified 2026-09-09; waiting on pinned image policy, synthetic compose/services and isolation evidence; assignee/accountable `Forge`; reviewers `Sentinel` + `Beacon`; escalation 2026-09-10; target Gate 0
  - Evidence: `docs/evidence/G0-004-G0-006-PREFLIGHT.md`
