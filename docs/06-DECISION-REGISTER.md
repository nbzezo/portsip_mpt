...
| D-002 | PortSIP contract | Public scan xác nhận PBX v22.6.3 + SBC v11.2.8, REST/WSI public v22.3, SDK native v19.6.2; browser artifact/customer entitlement còn thiếu | Verification 75% / Go-no-go | Telephony Lead + PortSIP vendor | Day 3 | [Public evidence](evidence/DISC-PS-001.md), [prepared exact-evidence request](evidence/PORTSIP-EXACT-CONTRACT-REQUEST.md); còn cần named owner gửi request và exact artifacts/license/sandbox response |
