...
| GitHub remote/workflow pushed, but first hosted run and protected-branch policy absent | `Forge` + `Atlas` + `Beacon` | Keeps `G0-04` blocked; [local preflight evidence](G0-004-G0-006-PREFLIGHT.md) |
