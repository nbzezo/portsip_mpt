...
| `G0-06` — synthetic environment | Blocked / 15%; Docker daemon available, synthetic stack/isolation còn thiếu | `Forge` | `Forge` | `Sentinel` + `Beacon` | Gate 0 | [Environment preflight](evidence/G0-004-G0-006-PREFLIGHT.md); image policy, services và isolation evidence còn thiếu |
