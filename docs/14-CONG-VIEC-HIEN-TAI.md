...
| `G0-04` — CI baseline | Blocked / 20%; first hosted run and branch protection còn thiếu | `Forge` | `Forge` + `Atlas` | `Beacon` | Gate 0 | [Environment preflight](evidence/G0-004-G0-006-PREFLIGHT.md); CI artifacts + protected-branch evidence còn thiếu |
